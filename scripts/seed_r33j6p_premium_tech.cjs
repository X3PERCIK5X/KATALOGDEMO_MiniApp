    ...
    homeBanners: [
      {
        ...
        title: 'Флагманские смартфоны для витрины, которая выглядит дорого',
        text: 'iPhone, Galaxy, Pixel и Xiaomi в clean premium-tech подаче: точные карточки, сильные фото и каталог без визуального шума.',
        cta: 'Открыть каталог',
      },
      {
        id: 'hero-ecosystem',
        ...
        kicker: 'Work & create',
        title: 'Ноутбуки и планшеты для работы, учебы и творчества',
        text: 'MacBook, iPad и премиальные Windows-устройства для клиентов, которым важны экран, скорость и ощущение собранной retail-витрины.',
      ...
      },
      {
        ...
        title: 'Аксессуары и аудио, которые дополняют каждую покупку',
        text: 'AirPods, зарядки, кабели, чехлы и power bank собирают полноценную premium-витрину и усиливают средний чек без перегруженной подачи.',
