    ...
    homeBanners: [
      {
        ...
        title: 'iPhone, Galaxy и Pixel без компромиссов',
        text: 'Собрали премиальную витрину флагманской техники: топовые смартфоны, официальные аксессуары и чистая retail-подача.',
        cta: 'Открыть каталог',
      },
      {
        id: 'hero-ecosystem',
        image: 'https://www.apple.com/v/macbook-air/y/images/meta/macbook_air_mx__ez5y0k5yy7au_og.png?202603041632',
        kicker: 'Work & create',
        title: 'MacBook и iPad для работы, учебы и креатива',
        text: 'Легкие ноутбуки, мощные планшеты и продуктивная экосистема для тех, кто ценит скорость, экран и комфорт в деталях.',
        cta: 'Смотреть новинки',
      },
      {
        id: 'hero-accessories',
        image: 'https://www.apple.com/v/airpods-pro/r/images/meta/og__c0ceegchesom_overview.png?202603151155',
        kicker: 'Audio & accessories',
        title: 'AirPods, MagSafe и аксессуары, которые дополняют покупку',
        text: 'От наушников и зарядок до чехлов и power bank: все, что превращает покупку техники в полноценный premium-набор.',
