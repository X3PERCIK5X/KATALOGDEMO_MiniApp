    ...
    homeBanners: [
      {
        ...
        title: 'Смартфоны, которые продают витрину сами',
        text: 'Флагманские iPhone, Galaxy, Pixel и Xiaomi в clean premium-tech подаче для демонстрации магазина высокого уровня.',
        cta: 'Открыть каталог',
      },
      {
        id: 'hero-ecosystem',
        ...
        kicker: 'Work & create',
        title: 'Ноутбуки и планшеты для работы без визуального шума',
        text: 'MacBook, iPad и премиальные Windows-устройства для клиентов, которым важны экран, скорость и ощущение дорогого продукта.',
        cta: 'Смотреть новинки',
      },
      {
        id: 'hero-accessories',
        image: 'https://images.unsplash.com/photo-1541807084-5c52b6b3adef?auto=format&fit=crop&w=1800&q=80',
        kicker: 'Audio & accessories',
        title: 'Аксессуары, которые повышают средний чек',
        text: 'Наушники, зарядки, чехлы, MagSafe и power bank — дополняют покупку техники и делают витрину полноценной.',
